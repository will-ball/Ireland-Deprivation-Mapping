...
We're going to combine the NDI dataset with the shapefile for small areas. Then we coerce it into a 'sf' format. At the same time we'll make sure Decile_2016 is seen as an ordianl variable (an ordered factor in R) 
